...
hmbGoddess.onclick=function(x){
  ...
  if(x=="Oslira"){
    altGoddess.value='Oslira is the goddess of the harvest and fall'
  }
  if(x=="Rutala"){
    altGoddess.value='Rutala is the goddess of stories and winter'
  }
  if(x=="Intris"){
    altGoddess.value='Intris is the goddess of the sun and summer'
  }
  if(x=="Medea"){
    altGoddess.value='Medea is the goddess of marriage and spring'
  }
}
